...
export default function TiltedCard({
    ...
    return (
        <figure
            ref={ref}
            className="relative w-full h-full [perspective:800px] flex flex-col items-center justify-center overflow-visible"
            style={{
        ...
        >
            ...
            {showTooltip && (
                <motion.figcaption
                    className="pointer-events-none absolute left-0 top-0 rounded-[4px] bg-white/90 backdrop-blur-sm px-[10px] py-[4px] text-[10px] text-black font-bold opacity-0 z-[3] hidden sm:block shadow-xl"
                    style={{
                        x,
                        y,
                        opacity,
