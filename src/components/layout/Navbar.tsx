    ...
    >
      <div className="container mx-auto flex items-center justify-between h-16 md:h-20 px-4">
        <Link to="/" className="flex items-center group">
          ...
          <img src="/aeyveruo.jpeg" alt="Aeyvan Technologies Logo" className="h-[3.2em] w-full object-contain logo-glow group-hover:scale-110 transition-all duration-500 -mb-2 mr-[-0.80em]" />
